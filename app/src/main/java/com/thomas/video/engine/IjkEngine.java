package com.thomas.video.engine;
...
/**
 * @author Thomas
 * @describe IJKPlayer播放引擎
 * @date 2019/8/16
 * @updatelog
 * @since
 */
public class IjkEngine extends JZMediaInterface implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnVideoSizeChangedListener, IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnTimedTextListener {
    IjkMediaPlayer ijkMediaPlayer;

    public IjkEngine(Jzvd jzvd) {
        super(jzvd);
    }
