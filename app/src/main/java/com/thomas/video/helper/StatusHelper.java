...
public class StatusHelper {
    ...
    private static volatile StatusHelper mDefault;
     ...
     * @return Gloading
     */
    public static StatusHelper from(Adapter adapter) {
        StatusHelper statusHelper = new StatusHelper();
        statusHelper.mAdapter = adapter;
        return statusHelper;
    }
     ...
     */
    public static StatusHelper getDefault() {
        if (mDefault == null) {
            synchronized (StatusHelper.class) {
                if (mDefault == null) {
                    mDefault = new StatusHelper();
                }
            }
        }
        return mDefault;
    ...
    /**
     * Gloading holder<br>
     * create by {@link StatusHelper#wrap(Activity)} or {@link StatusHelper#wrap(View)}<br>
